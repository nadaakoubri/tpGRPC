...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              comptes_ = new java.util.ArrayList<Compte>();
              mutable_bitField0_ |= 0x00000001;
            }
            comptes_.add(
                input.readMessage(Compte.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return CompteOuterClass.internal_static_GetComptesByTypeResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return CompteOuterClass.internal_static_GetComptesByTypeResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GetComptesByTypeResponse.class, Builder.class);
  }

  public static final int COMPTES_FIELD_NUMBER = 1;
  private java.util.List<Compte> comptes_;
  /**
   * <pre>
   ...
   */
  public java.util.List<Compte> getComptesList() {
    return comptes_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .Compte comptes = 1;</code>
   */
  public java.util.List<? extends CompteOrBuilder>
   ...
   * <code>repeated .Compte comptes = 1;</code>
   */
  public CompteOrBuilder getComptesOrBuilder(
      int index) {
    return comptes_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GetComptesByTypeResponse)) {
      return super.equals(obj);
    }
    GetComptesByTypeResponse other = (GetComptesByTypeResponse) obj;
  ...
  public static GetComptesByTypeResponse parseFrom(
  ...
  public static GetComptesByTypeResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GetComptesByTypeResponse parseFrom(
  ...
  public static GetComptesByTypeResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GetComptesByTypeResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GetComptesByTypeResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GetComptesByTypeResponse prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public GetComptesByTypeResponse getDefaultInstanceForType() {
      return GetComptesByTypeResponse.getDefaultInstance();
    }

    @Override
    public GetComptesByTypeResponse build() {
      GetComptesByTypeResponse result = buildPartial();
    ...
    @Override
    public GetComptesByTypeResponse buildPartial() {
      GetComptesByTypeResponse result = new GetComptesByTypeResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GetComptesByTypeResponse) {
        return mergeFrom((GetComptesByTypeResponse)other);
      } else {
    ...
    public Builder mergeFrom(GetComptesByTypeResponse other) {
      if (other == GetComptesByTypeResponse.getDefaultInstance()) return this;
      if (comptesBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GetComptesByTypeResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GetComptesByTypeResponse) e.getUnfinishedMessage();
    ...
    private void ensureComptesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        comptes_ = new java.util.ArrayList<Compte>(comptes_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        Compte, Compte.Builder, CompteOrBuilder> comptesBuilder_;
     ...
     */
    public Builder setComptes(
        int index, Compte.Builder builderForValue) {
      if (comptesBuilder_ == null) {
        ensureComptesIsMutable();
     ...
     * <code>repeated .Compte comptes = 1;</code>
     */
    public Builder addComptes(Compte value) {
      if (comptesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllComptes(
        Iterable<? extends Compte> values) {
      if (comptesBuilder_ == null) {
        ensureComptesIsMutable();
     ...
     * <code>repeated .Compte comptes = 1;</code>
     */
    public Compte.Builder getComptesBuilder(
        int index) {
     ...
     * <code>repeated .Compte comptes = 1;</code>
     */
    public Compte.Builder addComptesBuilder() {
      return getComptesFieldBuilder().addBuilder(
          Compte.getDefaultInstance());
    }
    /**
     * <pre>
     * List of comptes of the specified type
    ...
    public Compte.Builder addComptesBuilder(
        int index) {
      return getComptesFieldBuilder().addBuilder(
          index, Compte.getDefaultInstance());
    }
    /**
     * <pre>
     * List of comptes of the specified type
     ...
     * <code>repeated .Compte comptes = 1;</code>
     */
    public java.util.List<Compte.Builder>
  ...
  private static final GetComptesByTypeResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetComptesByTypeResponse();
  }

  public static GetComptesByTypeResponse getDefaultInstance() {
